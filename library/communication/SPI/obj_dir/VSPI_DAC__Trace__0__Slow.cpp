...
VL_ATTR_COLD void VSPI_DAC___024root__trace_init_sub_0(VSPI_DAC___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+6,"ST_rise", false,-1);
    tracep->declBit(c+7,"n_CS", false,-1);
    tracep->declBit(c+8,"SCK", false,-1);
    tracep->declBit(c+9,"SDI", false,-1);
    tracep->declBit(c+4,"SPI_DAC clk", false,-1);
    tracep->declBit(c+5,"SPI_DAC rst", false,-1);
    tracep->declBit(c+6,"SPI_DAC ST_rise", false,-1);
    tracep->declBit(c+7,"SPI_DAC n_CS", false,-1);
    tracep->declBit(c+8,"SPI_DAC SCK", false,-1);
    tracep->declBit(c+9,"SPI_DAC SDI", false,-1);
    tracep->declBus(c+12,"SPI_DAC SCK_div", false,-1, 31,0);
    tracep->declBus(c+13,"SPI_DAC cfg", false,-1, 3,0);
    tracep->declBus(c+14,"SPI_DAC data", false,-1, 7,0);
    tracep->declBus(c+15,"SPI_DAC data_out", false,-1, 15,0);
    tracep->declBus(c+16,"SPI_DAC cnt", false,-1, 3,0);
    tracep->declBus(c+10,"SPI_DAC SCK_cnt", false,-1, 3,0);
    tracep->declBit(c+11,"SPI_DAC r_SCK", false,-1);
    tracep->declBit(c+1,"SPI_DAC r_SDI", false,-1);
    tracep->declBit(c+2,"SPI_DAC r_CS", false,-1);
    tracep->declBus(c+3,"SPI_DAC index", false,-1, 3,0);
}
...
VL_ATTR_COLD void VSPI_DAC___024root__trace_full_sub_0(VSPI_DAC___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,(vlSelf->SPI_DAC__DOT__r_SDI));
    tracep->fullBit(oldp+2,(vlSelf->SPI_DAC__DOT__r_CS));
    tracep->fullCData(oldp+3,(vlSelf->SPI_DAC__DOT__index),4);
    tracep->fullBit(oldp+4,(vlSelf->clk));
    tracep->fullBit(oldp+5,(vlSelf->rst));
    tracep->fullBit(oldp+6,(vlSelf->ST_rise));
    tracep->fullBit(oldp+7,(vlSelf->n_CS));
    tracep->fullBit(oldp+8,(vlSelf->SCK));
    tracep->fullBit(oldp+9,(vlSelf->SDI));
    tracep->fullCData(oldp+10,(vlSelf->SPI_DAC__DOT__SCK_cnt),4);
    tracep->fullBit(oldp+11,(vlSelf->SPI_DAC__DOT__r_SCK));
    tracep->fullIData(oldp+12,(5U),32);
    tracep->fullCData(oldp+13,(0xcU),4);
    tracep->fullCData(oldp+14,(0x78U),8);
    tracep->fullSData(oldp+15,(0x78cU),16);
