...
VL_ATTR_COLD void Vtest___024root__trace_init_sub_0(Vtest___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD void Vtest___024root__trace_init_top(Vtest___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    Vtest___024root__trace_init_sub_0(vlSelf, tracep);
}

VL_ATTR_COLD void Vtest___024root__trace_init_sub_0(Vtest___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest___024root__trace_init_sub_0\n"); );
    // Init
    ...
    tracep->declBit(c+14,"test clk", false,-1);
    tracep->declBit(c+15,"test rst", false,-1);
    tracep->declBit(c+16,"test sig1", false,-1);
    tracep->declBit(c+17,"test out", false,-1);
    tracep->declBus(c+18,"test cnt_out", false,-1, 15,0);
    tracep->declBus(c+19,"test out_I", false,-1, 31,0);
    tracep->declBus(c+20,"test out_X0", false,-1, 31,0);
    tracep->declBus(c+21,"test out_X00", false,-1, 31,0);
    tracep->declBus(c+22,"test out_X1", false,-1, 31,0);
    tracep->declBus(c+23,"test out_X2", false,-1, 31,0);
    tracep->declBus(c+24,"test out_X22", false,-1, 31,0);
    tracep->declBus(c+25,"test out_di", false,-1, 31,0);
    tracep->declBus(c+26,"test out_di2", false,-1, 31,0);
    tracep->declBus(c+27,"test out_I_1", false,-1, 31,0);
    tracep->declBit(c+1,"test out_n", false,-1);
    tracep->declBus(c+2,"test cnt", false,-1, 15,0);
    tracep->declBus(c+3,"test cnt2", false,-1, 15,0);
    tracep->declBus(c+28,"test R", false,-1, 31,0);
    tracep->declBus(c+29,"test L_div", false,-1, 31,0);
    tracep->declBus(c+30,"test U0", false,-1, 31,0);
    tracep->declBus(c+31,"test dt", false,-1, 31,0);
    tracep->declBus(c+4,"test X0", false,-1, 31,0);
    tracep->declBus(c+5,"test X1", false,-1, 31,0);
    tracep->declBus(c+6,"test X2", false,-1, 31,0);
    tracep->declBus(c+7,"test di", false,-1, 31,0);
    tracep->declBus(c+32,"test i1", false,-1, 31,0);
    tracep->declBus(c+8,"test I", false,-1, 31,0);
    tracep->declBus(c+9,"test state", false,-1, 4,0);
    tracep->declBus(c+10,"test X00", false,-1, 31,0);
    tracep->declBus(c+11,"test X22", false,-1, 31,0);
    tracep->declBus(c+12,"test di2", false,-1, 31,0);
    tracep->declBus(c+13,"test I_1", false,-1, 31,0);
}
...
VL_ATTR_COLD void Vtest___024root__trace_full_sub_0(Vtest___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,(vlSelf->test__DOT__out_n));
    tracep->fullSData(oldp+2,(vlSelf->test__DOT__cnt),16);
    tracep->fullSData(oldp+3,(vlSelf->test__DOT__cnt2),16);
    tracep->fullIData(oldp+4,(vlSelf->test__DOT__X0),32);
    tracep->fullIData(oldp+5,(vlSelf->test__DOT__X1),32);
    tracep->fullIData(oldp+6,(vlSelf->test__DOT__X2),32);
    tracep->fullIData(oldp+7,(vlSelf->test__DOT__di),32);
    tracep->fullIData(oldp+8,(vlSelf->test__DOT__I),32);
    tracep->fullCData(oldp+9,(vlSelf->test__DOT__state),5);
    tracep->fullIData(oldp+10,(vlSelf->test__DOT__X00),32);
    tracep->fullIData(oldp+11,(vlSelf->test__DOT__X22),32);
    tracep->fullIData(oldp+12,(vlSelf->test__DOT__di2),32);
    tracep->fullIData(oldp+13,(vlSelf->test__DOT__I_1),32);
    ...
    tracep->fullIData(oldp+32,(vlSelf->test__DOT__i1),32);
}
