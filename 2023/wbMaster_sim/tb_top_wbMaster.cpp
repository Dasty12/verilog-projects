...
void dut_reset (Vtop_wbMaster *dut, vluint64_t &sim_time){
    dut->rst = 0;
...
void check_out_valid(Vtop_wbMaster *dut, vluint64_t &sim_time){
...
void set_rnd_out_valid(Vtop_wbMaster *dut, vluint64_t &sim_time)
{
    if(sim_time >= VERIF_START_TIME)
...
int main(int argc, char** argv, char** env) {
    ...
    Vtop_wbMaster *dut = new Vtop_wbMaster;
