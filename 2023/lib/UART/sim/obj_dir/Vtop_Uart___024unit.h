...
#ifndef _VTOP_UART___024UNIT_H_
#define _VTOP_UART___024UNIT_H_  // guard
...
VL_MODULE(Vtop_Uart___024unit) {
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vtop_Uart___024unit);  ///< Copying not allowed
  public:
    Vtop_Uart___024unit(const char* name = "TOP");
    ~Vtop_Uart___024unit();
