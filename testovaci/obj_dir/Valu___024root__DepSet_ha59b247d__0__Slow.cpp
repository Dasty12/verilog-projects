...
VL_ATTR_COLD void Valu___024root___initial__TOP__2(Valu___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Valu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Valu___024root___initial__TOP__2\n"); );
    // Body
    vlSelf->lin = 0U;
}

VL_ATTR_COLD void Valu___024root___settle__TOP__3(Valu___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Valu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Valu___024root___settle__TOP__3\n"); );
    // Body
...
VL_ATTR_COLD void Valu___024root___eval_initial(Valu___024root* vlSelf) {
    ...
    Valu___024root___initial__TOP__2(vlSelf);
}
...
VL_ATTR_COLD void Valu___024root___eval_settle(Valu___024root* vlSelf) {
    ...
    // Body
    Valu___024root___settle__TOP__3(vlSelf);
